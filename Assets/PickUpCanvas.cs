...
public class PickUpCanvas : MonoBehaviour
{
   ...
   [SerializeField] int winstep_;
    ...
    [SerializeField] GameObject ScreenUIPanel;
    [SerializeField] GameObject MekanText_Img;
    ...
    void EndGame() 
    {
        MekanText_Img.gameObject.SetActive(false);
    ...
    void HearthPlus() 
    {
        ScreenUIPanel.GetComponent<ScreenUI>().HearthPlus();
    }
    ...
    void TextChangeHelper() 
    {
        Firstline_t.text = Dialog[answerindex];

        DOTween.To(() => Firstline_t.maxVisibleCharacters, x => Firstline_t.maxVisibleCharacters = x, Firstline_t.text.Length, Firstline_t.text.Length * 0.03f)
        .From(0)
        .SetEase(Ease.Linear)
        .OnUpdate(() => Firstline_t.ForceMeshUpdate());
    ...
    void RandomFailText() 
    {
        ...
        DOTween.To(() => Firstline_t.maxVisibleCharacters, x => Firstline_t.maxVisibleCharacters = x, Firstline_t.text.Length, Firstline_t.text.Length * 0.02f)
        .From(0)
        .SetEase(Ease.Linear)
        .OnUpdate(() => Firstline_t.ForceMeshUpdate());
