...
public class SettingsPanelController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Vector3 OpenMenuInitial = OpenMenuButton.GetComponent<RectTransform>().anchoredPosition;
        OpenMenuButton.GetComponent<RectTransform>().DOAnchorPos(new Vector3(694, OpenMenuInitial.y, 0), 1).SetEase(Ease.InOutQuad);
